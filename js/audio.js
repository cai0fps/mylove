export function initAudio(songs) {
    ...
    // Verificação de segurança: Impede a quebra se o índice salvo for maior que a lista atual
    ...
    function loadSong(index) {
        ...
        // Verificação dupla para evitar bugs se a música já estiver no cachê do navegador
